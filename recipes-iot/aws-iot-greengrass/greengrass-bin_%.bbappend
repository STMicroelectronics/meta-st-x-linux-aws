...
do_install:append() {
    ...
    sed -i 's/OPTIONS="--setup-system-service false"/OPTIONS="--setup-system-service false --trusted-plugin $GG_ROOT\/bin\/aws.greengrass.crypto.Pkcs11Provider.jar"/g' ${GG_ROOT}/packages/artifacts-unarchived/aws.greengrass.Nucleus/${PV}/aws.greengrass.nucleus/bin/loader
}
